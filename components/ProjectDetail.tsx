    ...
    <div className="min-h-screen bg-m3-surface animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="pt-32 pb-16 px-4 md:px-12 max-w-[98vw] mx-auto">
         ...
         <div className="relative mb-24">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              {project.tags.map(tag => (
                <span key={tag} className="px-6 py-2 rounded-full border border-m3-on-surface text-m3-on-surface text-sm font-bold uppercase tracking-wider">
                  {tag}
                </span>
              ))}
            </div>
         ...
         <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 border-y border-m3-on-surface/10 py-12">
            <div>
               <span className="block text-xs font-bold text-swiss-red uppercase tracking-widest mb-2">Client</span>
               <span className="text-xl md:text-2xl font-bold text-m3-on-surface">{project.client}</span>
            </div>
            <div>
               <span className="block text-xs font-bold text-swiss-red uppercase tracking-widest mb-2">Role</span>
               <span className="text-xl md:text-2xl font-bold text-m3-on-surface">{project.role}</span>
            </div>
            <div>
               <span className="block text-xs font-bold text-swiss-red uppercase tracking-widest mb-2">Year</span>
               <span className="text-xl md:text-2xl font-bold text-m3-on-surface">{project.year}</span>
            </div>
            <div>
               <span className="block text-xs font-bold text-swiss-red uppercase tracking-widest mb-2">Category</span>
               <span className="text-xl md:text-2xl font-bold text-m3-on-surface">{project.category}</span>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
            ...
            <div className="lg:col-span-5">
               <div className="sticky top-32">
                 <div className="aspect-[3/4] rounded-[3rem] overflow-hidden bg-m3-secondary-container relative">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-m3-surface/50 to-transparent"></div>
                 </div>
               </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-20">
               <section>
                  <h3 className="text-4xl font-black mb-8 text-m3-on-surface">The Challenge</h3>
               ...
               <section>
                  <h3 className="text-4xl font-black mb-8 text-m3-on-surface">The Solution</h3>
               ...
               <div className="bg-m3-primary-container rounded-[2rem] p-8 md:p-12">
                  ...
                  <a href={project.link} className="inline-flex items-center gap-2 text-m3-on-primary-container font-bold uppercase tracking-widest hover:text-swiss-red transition-colors">
      ...
      >
         <div className="relative z-10 flex flex-col items-center justify-center text-center">
            <span className="text-sm font-bold uppercase tracking-[0.3em] mb-4 text-m3-surface-variant">Next Case</span>
