...
const ChatWidget: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "model",
      text: "Hi! I am sumit's AI assistant. Ask me anything about his work, skills, or availability.",
      timestamp: new Date(),
    },
  ]);
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {isOpen && (
        <div className="mb-4 w-80 md:w-96 bg-m3-surface rounded-3xl shadow-2xl overflow-hidden border border-m3-surface-variant flex flex-col origin-bottom-right animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="bg-m3-primary-container px-6 py-4 flex justify-between items-center">
            <div>
              <h3 className="font-bold text-m3-on-primary-container">
                AI Assistant
              </h3>
              <span className="text-xs text-m3-on-primary-container/70">
                Powered by Gemini
              </span>
            </div>
            <button
              onClick={() => setIsOpen(false)}
              className="text-m3-on-primary-container hover:bg-black/5 p-2 rounded-full"
            >
              <svg
                className="w-5 h-5"
                fill="none"
      ...
      >
        ...
        {isOpen ? (
          ...
          >
            <path
              d="M15 4V2M15 4V6M15 4H13M15 4H17M5 16V14M5 16V18M5 16H3M5 16H7M12 15L10 10L12 5L14 10L12 15ZM19 13L18 11L19 9L20 11L19 13Z"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
