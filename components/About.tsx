    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <div className="space-y-6 text-lg text-m3-on-surface-variant leading-relaxed">
          <p>
            I am Alex, a product designer and engineer who believes that structure doesn't have to be boring.
            My work sits at the intersection of systematic Swiss design and the playful, adaptive nature of modern web technologies.
          </p>
          <p>
            With over 8 years of experience, I build design systems that scale and user interfaces that feel alive.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-m3-primary-container text-m3-on-primary-container">
            ...
            <div className="text-sm font-medium opacity-80">Projects Shipped</div>
          </div>
        </div>
      </div>
    </div>
