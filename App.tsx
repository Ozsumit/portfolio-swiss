...
const App: React.FC = () => {
  ...
  // If a project is selected, it overlays everything else
  if (activeProject) {
    return (
            ...
            <div className="w-full max-w-[96vw] mx-auto px-4 md:px-0 space-y-20 md:space-y-32 pb-20 pt-10">
                ...
                <section id={SectionId.CONTACT}>
                  <div className="flex flex-col items-center justify-center text-center w-full bg-m3-secondary-container rounded-[3rem] py-24 md:py-32 relative overflow-hidden">
                      ...
                      <span className="relative z-10 text-sm font-bold uppercase tracking-[0.3em] text-m3-on-secondary-container mb-8">Ready to start?</span>
                      ...
                      >
                        <span className="relative z-10 group-hover:-translate-y-24 transition-transform duration-300 block">alex@example.com</span>
                        <span className="absolute z-10 translate-y-24 group-hover:translate-y-0 transition-transform duration-300 block">Say Hello!</span>
                      </a>
                  </div>
                </section>
            </div>
